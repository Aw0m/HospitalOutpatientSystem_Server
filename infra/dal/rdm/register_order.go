...
type RegisterOrder struct {
	...
	Price            float64 `gorm:"column:price;type:double;default:0;NOT NULL" json:"price"`
	HasGetMedication bool    `gorm:"column:has_get_medication;type:tinyint(1);default:0" json:"has_get_medication"`
}
